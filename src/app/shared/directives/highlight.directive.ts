...
export class HighlightDirective implements OnInit {
  ...
  @HostListener('mouseenter') onMouseEnter() {
    this.renderer.setStyle(this.element.nativeElement, this.setHighlight.shadow, `${this.setHighlight.shadowX} ${this.setHighlight.shadowY} ${this.setHighlight.shadowBlur} 2px rgba(0,0,0,.2)`);
  }
